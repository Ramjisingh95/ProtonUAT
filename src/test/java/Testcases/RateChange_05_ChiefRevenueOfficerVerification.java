...
public class RateChange_05_ChiefRevenueOfficerVerification extends BaseTest {

    @Test
    public void ChiefRevenueOfficerVerification() throws InterruptedException {
        // Use locators for login
    	Thread.sleep(4000);
        driver.findElement(Locators.emailInput).sendKeys("MANISH.BHARGAVA");
        Thread.sleep(4000);
