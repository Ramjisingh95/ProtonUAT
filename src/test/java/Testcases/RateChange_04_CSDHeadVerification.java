...
public class RateChange_04_CSDHeadVerification extends BaseTest {

    @Test
    public void CSDHeadVerification() throws InterruptedException {
        // Use locators for login
    	
        Thread.sleep(3000);
        driver.findElement(Locators.emailInput).sendKeys("NEELABH.UPADHYAY");
        Thread.sleep(3000);
